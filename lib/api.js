...
class QuorumOwner {
  ...
  static byteCode = QuorumOwnerByteCode
  ...
  debug (destination, method, signature, args, value = 0, gas = 21000) {
    return this._contract.methods.debug(
        destination,
        abi.methodID(method, signature),
        value,
        gas,
        abi.solidityPack(signature, args)
      )
  }
