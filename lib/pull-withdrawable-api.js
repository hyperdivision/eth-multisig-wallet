...
const { abi: PullWithdrawableABI, bytecode: PullWithdrawableByteCode, deployedBytecode: PullWithdrawableDeployedByteCode } = require('../build/PullWithdrawable.json')
...
class PullWithdrawable {
  ...
  setQuorumParams (method) {
    return [
      this.address,
      method,
      PullWithdrawable.typeSignatures[method],
    ]
  }
