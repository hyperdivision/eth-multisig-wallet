...
module.exports = async (cb) => {
  try {
    ...
    console.log(QuorumOwners.allOwnersDecode(await web3.eth.call({
    ...
    return
    const deployDepo = Deposit.create(c.options.address, dest)
    ...
    var dd = new Deposit(web3, d.contractAddress)
    ...
    const proposal = await q.setQuorumType([Deposit.codehash, 'replaceOwner', Deposit.typeSignatures.replaceOwner], 0.5)
